...
🚀 **[Dev Portfolio V2 has arrived. Meet Devfolio, a modern portfolio + blog template built with GatsbyJS and TailwindCSS](https://github.com/kamaalmohd79.github.io)** 🚀
...
To view a live demo, [click here](https://kamaalmohd79.github.io/).
...
```HTML
<a href="resume/p_MohdKamaalResumeFullstack.pdf" download="resume.pdf" class="btn-rounded-white">Download Resume</a>
```
